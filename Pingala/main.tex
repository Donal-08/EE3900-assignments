...
\author{Donal Loitam - AI21BTECH11009}% <-this % stops a space
...
\begin{lstlisting}
wget https://github.com/Donal-08/EE3900/blob/main/Pingala/codes/1.1.py
\end{lstlisting}
...
\solution Download and run the following code.
\begin{lstlisting}
wget https://github.com/Donal-08/EE3900/blob/main/Pingala/codes/1.2.py
\end{lstlisting}
run the above code using the command
\begin{lstlisting}
    python3 1.2.py
...
\solution Download and run the following code.
\begin{lstlisting}
wget https://github.com/Donal-08/EE3900/blob/main/Pingala/codes/1.3.py
\end{lstlisting}
run the above code using the command
\begin{lstlisting}
    python3 1.3.py
...
\solution Download and run the following code.
\begin{lstlisting}
wget https://github.com/Donal-08/EE3900/blob/main/Pingala/codes/1.4.py
\end{lstlisting}
run the above code using the command
\begin{lstlisting}
    python3 1.4.py
...
\begin{lstlisting}
wget https://github.com/Donal-08/EE3900/blob/main/Pingala/Codes/2.2.py
\end{lstlisting}
run the above code using the command
\begin{lstlisting}
	python3 2.2.py
...
\begin{lstlisting}
wget https://github.com/Donal-08/EE3900/blob/main/Pingala/codes/2.4.py
\end{lstlisting}
run the above code using the command
\begin{lstlisting}
    python3 2.4.py
...
\begin{lstlisting}
wget https://github.com/Donal-08/EE3900/blob/main/Pingala/Codes/2.5.py
\end{lstlisting}
run the above code using the command
\begin{lstlisting}
	python3 2.5.py
...
Download and run the following code.
\begin{lstlisting}
wget https://github.com/Donal-08/EE3900/blob/main/Pingala/codes/2.7.py
\end{lstlisting}
run the above code using the command
\begin{lstlisting}
    python3 2.7.py
...
\begin{lstlisting}
wget https://github.com/Donal-08/EE3900/blob/main/Pingala/codes/3.6.py
\end{lstlisting}
